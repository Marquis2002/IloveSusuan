...
# Now we have mnist thing
mnist = input_data.read_data_sets('data/', one_hot=True)
# temp = 0.89

# And we have a class train
class Train(object):
    # initial function, contains args: see, img_size, trainable, batch_size, lr, mm. z_dim, EPOCH, LAMBDA, model, dim, num_class. load_model.
    # then jump into build_model function
    def __init__(self, sess, args):
        #sess=tf.Session()
        # tf is tensorflow
        self.sess = sess
        self.img_size = 28   # the size of image
        # like a Hong Definition
        self.trainable = True
